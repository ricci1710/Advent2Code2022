import {MOCK_DATA_DAY_11} from "./data11";
import {MOCK_DEMO_DATA_DAY_11} from "./demo11";
 ...
 * Monkey 2:
 * Monkey 3:
 * Chasing all the monkeys at once is impossible; you're going to have to focus on the two most active monkeys if you want any hope of getting your stuff back. Count the total number of times each monkey inspects items over 20 rounds:
 *
...
const Logic11 = () => {
  ...
  const data = MOCK_DATA_DAY_11.split('\n');
  const demoData = MOCK_DEMO_DATA_DAY_11.split('\n');
