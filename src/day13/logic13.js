import {MOCK_DATA_DAY_13} from "./data13";
import {MOCK_DEMO_DATA_DAY_13} from "./demo13";

const Logic13 = () => {
  // region prepare mock data
  const data = MOCK_DATA_DAY_13.split('\n');
  const demoData = MOCK_DEMO_DATA_DAY_13.split('\n');
