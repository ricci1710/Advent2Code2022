 ...
 *
 * First, create a list of coordinates, which we will use as a queue. The queue will be initialized with one coordinate,
 * the end coordinate. Each coordinate will also have a counter variable attached (the purpose of this will soon become
 * evident). Thus, the queue starts off as ((3,8,0)).
 *
 * Then, go through every element in the queue, including new elements added to the end over the course of the
 ...
 * (in our example, the four cells are ((2,8,1),(3,7,1),(4,8,1),(3,9,1)))
 ...
 * After 7 turns: (...(1,3,7)) – problem solved, end this stage of the algorithm – note that if you have multiple units
 * chasing the same target (as in many games – the finish to start approach of the algorithm is intended to make this
 * easier), you can continue until the entire map is taken up, all units are reached or a set counter limit is reached
 *
 * @constructor
 */
const Logic12 = () => {
