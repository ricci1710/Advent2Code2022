import {MOCK_DATA_DAY_16} from "./data16";
import {MOCK_DEMO_DATA_DAY_16} from "./demo16";
 ...
 * such a system got into a volcano, but you don't have time to complain;
...
const Logic16 = () => {
  ...
  const data = MOCK_DATA_DAY_16.split('\n');
